...
* vendor/mediatek/proprietary/bootable/bootloader/preloader/
  └── platform/mt6761/src/core/main.c
      └── void main(u32 *arg)
          ├── bldr_pre_process();
          │   ├── platform_pre_init();                          --> hardware initialization. e.g. timer, pll, uart...
          │   ├── platform_init();                              --> hardware initialization
          │   │   └── platform/mt6761/src/drivers/platform.c
