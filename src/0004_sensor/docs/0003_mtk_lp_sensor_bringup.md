...
* [简介](#简介)
* [lp sensor 驱动加载](#lp-sensor-驱动加载)
  * [代码修改主要包含几个部分](#代码修改主要包含几个部分)
  * [代码修改](#代码修改)
  * [bring up l/p sensor 问题排查](#bring-up-lp-sensor-问题排查)
* [proximity sensor 的校准](#proximity-sensor-的校准)
* [light sensor 的校准](#light-sensor-的校准)
* [light sensor上报由亮度、可见光、红外光](#light-sensor上报由亮度可见光红外光)
